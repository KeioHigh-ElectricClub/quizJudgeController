...
// designation #define TFT_CS   PIN_D8  // Chip select control pin D8 #define
// TFT_DC   PIN_D3  // Data Command control pin #define TFT_RST  PIN_D4  //
...
// #define TFT_BL
//   32  // LED back-light (only for ST7789 with backlight control pin)
